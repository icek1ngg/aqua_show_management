            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between px-1">
                  ...
                  <Link className="text-sm font-bold text-cyan-700 transition hover:text-cyan-900" to="/forgot-password">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
              ...
              <div className="flex items-center my-4">
                ...
                <span className="mx-4 flex-shrink text-sm text-slate-400 font-medium">or</span>
                <div className="flex-grow border-t border-cyan-100" />
              </div>
